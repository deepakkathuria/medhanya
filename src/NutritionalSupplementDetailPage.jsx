...
const NutritionalSupplementsDetailPage = () => {
  const products = [
    "L-Carnitine",
  ...
  return (
    <div className="bg-gradient-to-r from-cyan-200 to-blue-500 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <img
          src="https://res.cloudinary.com/dqdaz8ni5/image/upload/v1719557413/Natural_supplement_dmqnhs.webp"
...
export default NutritionalSupplementsDetailPage;
